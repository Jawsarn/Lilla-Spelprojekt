...
{
	AddButton("Volume", DirectX::XMFLOAT2(0,0.6),0.5,0.1, L"Volume1.dds",L"Volume2.dds");
	...
	m_graphicHandle->CreateHUDObject(DirectX::XMFLOAT2(0,0.8),DirectX::XMFLOAT2(0.5,0.05),t_volumeSlideTextures,t_volumeSlideHandle);
