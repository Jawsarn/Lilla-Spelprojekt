...
void GraphicHandle::CreateShipForGame(std::vector<XMFLOAT4X4> p_PlayerWorld)
{
	for (int i = 0; i < m_Player.size(); i++)
	{
		...
		m_GraphicEngine->CreateParticleCBSetup(XMFLOAT3(0,0,0), XMFLOAT3(0,0,0), 1, 4.0f, XMFLOAT2(0.2f,0.2f), 1.0f, t_ParticleBufferDataID1);
		m_GraphicEngine->CreateParticleCBSetup(XMFLOAT3(0,0,0), XMFLOAT3(0,0,0), 1, 4.0f, XMFLOAT2(0.2f,0.2f), 1.0f, t_ParticleBufferDataID2);
