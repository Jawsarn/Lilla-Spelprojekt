...
int CollisionManager::PlayerVsPlayerWall(BoundingOrientedBox* p_player, std::vector<PlayerWall*> p_collisionBoxes) //copies the list. Might be bad, but its a list of pointers. No biggie
{
